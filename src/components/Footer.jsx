...
const Footer = () => {
  return (
    <footer className="w-full fixed bottom-0 left-0 py-5 px-4 md:px-14 bg-navBg flex items-center justify-between text-textPrimary">
      <Link to="/">
        <h2 className="text-xl md:text-2xl lg:text-3xl font-semibold">
          N(c)ews
        </h2>
      </Link>
      <p className="max-w-[180px] md:max-w-[400px] text-xs md:text-sm lg:text-base text-center">
